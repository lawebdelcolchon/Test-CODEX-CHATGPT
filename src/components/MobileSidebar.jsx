...
export default function MobileSidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Overlay */}
      <div 
        className="bg-ui-bg-overlay fixed inset-0 z-40 lg:hidden" 
        onClick={onClose}
      />
      
      {/* Mobile Sidebar */}
      <div className="bg-ui-bg-subtle shadow-elevation-modal fixed inset-y-2 left-2 flex w-full max-w-[304px] flex-col overflow-hidden rounded-lg border-r z-50 lg:hidden">
        {/* Close Button Header */}
        <div className="p-3">
          <button 
            type="button" 
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="none">
              <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m11.25 3.75-7.5 7.5M3.75 3.75l7.5 7.5" />
            </svg>
          </button>
          <h2 className="sr-only">Navegación</h2>
          <p className="sr-only">Menú de navegación para el panel.</p>
        </div>
