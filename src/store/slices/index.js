...
export const attributesActions = allActions.attributes;
export const optionsActions = allActions.options;

// Selectors específicos por modelo
export const categoriesSelectors = allSelectors.categories;
export const attributesSelectors = allSelectors.attributes;
export const optionsSelectors = allSelectors.options;
